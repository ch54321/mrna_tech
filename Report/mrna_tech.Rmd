...
As Figure 1 indicates, the rapid development of the mRNA technology is manifested in an increasing number of patent applications relative to all pharma patent applications at the <a href="https://www.uspto.gov/" target ="blank">US patent office (USPTO)</a> in the past several years. This surge in innovation is likely one reason why mRNA based vaccines against covid-19 could have been developed at a record pace. The success of the mRNA technology in vaccinating against Covid-19 could now lead to new breakthroughs in other areas as well, particularly in cancer therapy. 
